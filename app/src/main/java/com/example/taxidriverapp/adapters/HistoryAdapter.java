...
public class HistoryAdapter extends RecyclerView.Adapter<HistoryAdapter.ViewHolder> {
    ...
    public HistoryAdapter(Context context, SQLiteDatabase db) {
        ...
        Cursor cursor = db.query(DatabaseHelper.DATABASE_TABLE,
                new String[]{
                        ...
                        DatabaseHelper.CONTENT_ID_IN_GLOBAL_DB
                },
        ...
        if (cursor.getCount() > 0) {
            do {
                ...
                id[pointer] = cursor.getInt(cursor.getColumnIndex(DatabaseHelper.CONTENT_ID_IN_GLOBAL_DB));
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        holder.orderId.setText("id: " + id[position]);
